...
my $outdir = '/sandman/PERMUTATIONS/';
my $logdir = '/sandman/gen_perms/';
my $tmpdir = '/tmp/';
my $datadir = '/sandman/GENOTYPES/';
my $queue = 'all.q';
my $qsubcmd="qsub -q $queue -v R_LIBS=/sandman/R_packages/";
my $RSCRIPT = '/home/sandman/GIT_REPOS/sandman/SUPPORT/R/run_perm_test.R';
